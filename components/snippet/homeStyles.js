...
export const s = {
  ...
  mainPlayerBleed: {
    ...
    paddingBottom: "calc(8.25rem + env(safe-area-inset-bottom, 0px))",
    display: "flex",
    flexDirection: "column",
    minHeight: "100dvh",
    overflow: "hidden",
  ...
  playerSnippetDock: {
    ...
    paddingRight: "1rem",
    paddingTop: "0.65rem",
    /** Insets only — outer <main> mainPlayerBleed already clears fixed mini + tab bar. */
    paddingBottom: "1rem",
